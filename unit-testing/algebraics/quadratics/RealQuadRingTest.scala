...
class RealQuadRingTest {
  ...
  @Test def testHashCode(): Unit = {
    ...
    assertEquals(oldHash, newHash)
    sameRing = new RealQuadRing(testDiscr)
    newHash = sameRing.hashCode
  ...
  @Test def testToString(): Unit = {
    ...
    if (testDiscr % 4 == 1) {
      assertEquals("O_(Q(sqrt(" + testDiscr.toString + ")))", ringRandom.toString)
    } else {
      assertEquals("Z[sqrt(" + testDiscr.toString + ")]", ringRandom.toString)
    }
  }
  ...
  @Test def testToUnicodeString(): Unit = {
    ...
    if (testDiscr % 4 == 1) {
      assertEquals("O_(\u211A(\u221A(" + testDiscr.toString + ")))", ringRandom.toUnicodeString)
    } else {
      assertEquals("\u2124[\u221A(" + testDiscr.toString + ")]", ringRandom.toUnicodeString)
    }
    ...
    if (testDiscr % 4 == 1) {
      assertEquals("O_(Q(\u221A(" + testDiscr.toString + ")))", ringRandom.toUnicodeString)
    } else {
      assertEquals("Z[\u221A(" + testDiscr.toString + ")]", ringRandom.toUnicodeString)
    }
  }
  ...
  @Test def testToTeXString(): Unit = {
    ...
    if (testDiscr % 4 == 1) {
      assertEquals("\\mathcal O_{\\mathbb Q(\\sqrt{" + testDiscr.toString + "})}", ringRandom.toTeXString)
    } else {
      assertEquals("\\mathbb Z[\\sqrt{" + testDiscr.toString + "}]", ringRandom.toTeXString)
    }
    IntRing.preferenceForBlackboardBold = false
    ...
    if (testDiscr % 4 == 1) {
      assertEquals("\\mathcal O_{\\textbf Q(\\sqrt{" + testDiscr.toString + "})}", ringRandom.toTeXString)
    } else {
      assertEquals("\\textbf Z[\\sqrt{" + testDiscr.toString + "}]", ringRandom.toTeXString)
    }
  }
  ...
  @Test def testToHTMLString(): Unit = {
    ...
    if (testDiscr % 4 == 1) {
      assertEquals("<i>O</i><sub>&#x211A;(&radic;(" + testDiscr.toString + "))</sub>", ringRandom.toHTMLString)
    } else {
      assertEquals("&#x2124;[&radic;(" + testDiscr.toString + ")]", ringRandom.toHTMLString)
    }
    IntRing.preferenceForBlackboardBold = false
    ...
    if (testDiscr % 4 == 1) {
      assertEquals("<i>O</i><sub><b>Q</b>(&radic;(" + testDiscr.toString + "))</sub>", ringRandom.toHTMLString)
    } else {
      assertEquals("<b>Z</b>[&radic;(" + testDiscr.toString + ")]", ringRandom.toHTMLString)
    }
  }
  ...
  @Test def testToFilenameString(): Unit = {
    ...
    if (testDiscr % 4 == 1) {
      assertEquals("OQ" + testDiscr.toString, ringRandom.toFilenameString)
    } else {
      assertEquals("Z" + testDiscr.toString, ringRandom.toFilenameString)
    }
  }
  ...
  @Test def testGetRadSqrt(): Unit = {
    ...
    assertEquals(Math.sqrt(testDiscr), ringRandom.getRadSqrt, testDelta)
  }
  ...
  @Test def testGetAbsNegRad(): Unit = {
    ...
    assertEquals(testDiscr, ringRandom.getAbsNegRad)
  }
  ...
  @Test def testGetAbsNegRadSqrt(): Unit = {
    ...
    assertEquals(Math.sqrt(testDiscr), ringRandom.getAbsNegRadSqrt, testDelta)
  }
